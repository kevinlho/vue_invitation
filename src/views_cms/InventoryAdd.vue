...
export default {
  ...
  methods: {
    getInvitationList() {
      //Todo: get invitation details here
    },
    addInventory(){
    }
  },
...
<template>
  <v-container>
    <v-card className="d-flex flex-column pa-10 align-self-center">
      <span className="mb-10 align-self-center">Add Inventory</span>
      <v-row>
        <v-text-field
      ...
      <v-btn style="color: black; max-width: 128px; align-self: center" className="mt-5">Submit</v-btn>
    </v-card>
  </v-container>
</template>
